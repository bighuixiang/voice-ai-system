...
import { VoiceAIClient, ErrorType, type APIConfig, type TextInputData, type VoiceOptions } from './api'
...
describe('VoiceAIClient', () => {
  ...
  describe('语音处理', () => {
    ...
    it('应该验证文件大小', async () => {
      const largeFile = new File(['large audio data'], 'large.wav', { type: 'audio/wav' })
