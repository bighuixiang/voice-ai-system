# Voice AI Decision System

一个基于本地大模型的轻量级语音处理和智能决策平台。系统接收语音文件或文本输入，通过本地部署的 AI 模型进行内容理解和智能决策，支持知识库增强和插件扩展。

## 🚀 特性

- **多模态输入**: 支持语音文件（WAV, MP3, M4A, FLAC）和文本输入
- **本地 AI 模型**: 使用 Whisper 进行语音识别，集成轻量级语言模型（Qwen2-1.5B）
- **知识库增强**: 支持文档上传和智能检索，提供上下文相关的决策支持
- **容器化部署**: 完整的 Docker 容器化解决方案，支持一键部署
- **高性能**: 优化的资源管理和并发处理能力
- **可扩展**: 模块化架构，支持插件和功能扩展
