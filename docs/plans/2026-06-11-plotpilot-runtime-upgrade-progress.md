...
- Quality persistence:
  ...
  - Metrics include averages, weakest chapters, rhythm signals, and character arc signals.
...
- Tension curve and style-drift metrics beyond the current quality dimensions.
