...
export function evaluateSeedBranchQuestion(input: { questionId: string; answers: ReadonlyArray<{ answer: string; affectedFields: readonly string[]; branchSignature: string }>; ignoredQuestions?: readonly string[] }): SeedBranchQuestionResult {
...
export function createSeedContractCandidates(input: { sharedFacts: readonly string[]; candidates: ReadonlyArray<Omit<SeedContractCandidates["candidates"][number], "sharedFacts">> }): SeedContractCandidates {
