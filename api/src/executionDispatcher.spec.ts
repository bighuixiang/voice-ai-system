...
async function fixture() {
  ...
  const versionBase = { schemaVersion: "outline-version.v1", versionId: "outline-version-v1", projectSlug: "demo", version: 1, outlineId: "outline-1", outlineFingerprint: "outline-fp", selectedChapterIds: ["c1"], strongFreezeCount: 3, structureVersionFingerprint: "outline-fp", changeLevel: "L0", adoptionAuthority: "author", adoptionProofFingerprint: "adoption-proof-1", status: "active", canonWritten: true, createdAt: new Date().toISOString() };
