...
async function fixture() {
  ...
  const proofBase = { schemaVersion: "execution-ready-proof.v1", proofId: "execution-ready-outline-version-outline-candidate-demo", projectSlug: "demo", versionId: version.versionId, versionFingerprint: version.fingerprint, status: "ready", executionReady: true, checks: [], createdAt: new Date().toISOString() };
