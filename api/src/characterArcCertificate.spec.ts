...
const base = { arcId: "arc-1", characterId: "hero", targetChange: "accept reciprocal trust", startState: "isolated", milestones: [{ milestoneId: "m1", choiceEvidenceId: "choice-1", actualChange: "protects ally", cost: "loses escape route", relationshipEvidenceRefs: ["relationship://1"], sourceRefs: ["chapter://1"] }], staleDependencyIds: [], sourceRefs: ["arc://1"] };
