...
describe("runtime worker restart recovery", () => {
  ...
  const versionBase = { schemaVersion: "outline-version.v1", versionId: "outline-worker", projectSlug: project.slug, version: 1, outlineId: "outline-worker", outlineFingerprint: "outline-worker-fp", selectedChapterIds: [chapter.id], strongFreezeCount: 1, structureVersionFingerprint: "outline-worker-fp", changeLevel: "L0", adoptionAuthority: "author", adoptionProofFingerprint: "adoption-proof-1", status: "active", canonWritten: true, createdAt: new Date().toISOString() };
